...
namespace DeltaHRMS.Tests.TestScripts.Appraisals
{
    ...
    /// </summary>
    class ConfigureAppraisalsSkills : BaseTest
    {
        /// <summary>
        ...
        protected override void ExecuteTestCase()
        {
            try
            {
                ...
                pg_Hrms.SelectMenuSubMenuFromSideBar(SIDEBARMENUNAMES.CONFIGURATION.GetDescription(), SIDEBARSUBMENUNAMES.SKILLS.GetDescription());

                Step = "Adding Appraisals Skills";
                pg_Hrms.AddAppraisalsSkills();

                //Step = "Deleting Appraisals Skills";
                //pg_Hrms.DeleteSkills();
