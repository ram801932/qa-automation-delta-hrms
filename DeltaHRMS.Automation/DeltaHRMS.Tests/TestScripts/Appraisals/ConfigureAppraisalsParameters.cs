...
namespace DeltaHRMS.Tests.TestScripts.Appraisals
{
    ...
    /// </summary>
    class ConfigureAppraisalsParameters : BaseTest
    {
        /// <summary>
        ...
        protected override void ExecuteTestCase()
        {
            try
            {
                ...
                Step = "Navigate to Configuration -> Parameters";
                pg_Hrms.SelectMenuSubMenuFromSideBar(SIDEBARMENUNAMES.CONFIGURATION.GetDescription(), SIDEBARSUBMENUNAMES.PARAMETERS.GetDescription());

                Step = "Adding Appraisals Parameters";
                pg_Hrms.AddParameters();

                Step = "Deleting Appraisals Parameters";
                pg_Hrms.DeleteParameters();
