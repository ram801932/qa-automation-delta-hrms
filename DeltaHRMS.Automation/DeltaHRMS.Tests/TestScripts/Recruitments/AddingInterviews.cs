...
namespace DeltaHRMS.Tests.TestScripts.Recruitments
{
    ...
    /// </summary>
    class AddingInterviews : BaseTest
    {
        /// <summary>
        ...
        protected override void ExecuteTestCase()
        {
            try
            {
                ...
                //pg_Hrms.AddingInterviews(TestDataNode["reqCode"].InnerText, TestDataNode["CandidateName"].InnerText, TestDataNode["location"].InnerText, 
                //                        TestDataNode["interviewType"].InnerText, DateTime.Now.ToString("dd-MM-yyyy"), TestDataNode["time"].InnerText,
