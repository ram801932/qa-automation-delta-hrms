...
{
    [Script("", "", "DeltaHRMS", "SelfService", "HR - Apply Impersonate Leave", "HR Apply Impersonate Leave on behalf of Employee", "Regression")]
    /// <summary>
    ///  Delta HRMS - Cancel Approved Leave
    /// </summary>
    class HrApplyImpersonateLeave : BaseTest
    {
        /// <summary>
        ...
        protected override void ExecuteTestCase()
        {
            try
            {
                ...
                pg_Hrms.CreateImpersonateLeaveRequest(LEAVETYPES.EARNEDLEAVE.GetDescription(), date, date, FULLDAYLEAVE, userName[1]);
