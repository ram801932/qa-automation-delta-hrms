...
{
    [Script("", "", "DeltaHRMS", "SelfService", "HR - Apply Compensatory Leave", "HR Apply Compensatory Leave for Employee", "Regression")]
    /// <summary>
    ///  Delta HRMS - Cancel Approved Leave
    /// </summary>
    class HrApplyCompensatoryLeave : BaseTest
    {
        /// <summary>
        ...
        protected override void ExecuteTestCase()
        {
            try
            {
                ...
                pg_Hrms.CreateImpersonateLeaveRequest(LEAVETYPES.COMPOFF.GetDescription(), date, date, FULLDAYLEAVE, userName[1]);
