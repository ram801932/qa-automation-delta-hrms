...
{
    [Script("", "", "DeltaHRMS", "SelfService", "Manager - Approve Applied Leave", "Create a Leave Request & Manager Approves", "Regression")]
    /// <summary>
    ///  Manager - Approve Applied Leave
    /// </summary>
    class ManagerApporveAppliedLeave : BaseTest
    {
        /// <summary>
