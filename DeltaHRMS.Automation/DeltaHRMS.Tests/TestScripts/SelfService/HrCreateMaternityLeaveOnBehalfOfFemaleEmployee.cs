...
{
    [Script("", "", "DeltaHRMS", "SelfService", "HR - Apply Maternity Leave for Female Employee", "HR Create a Maternity Leave Request for Female Employee", "Regression")]
    /// <summary>
    ///  Employee - Create & Cancel Leave Request
    /// </summary>
    class HrCreateMaternityLeaveOnBehalfOfFemaleEmployee : BaseTest
    {
        /// <summary>
        ...
        protected override void ExecuteTestCase()
        {
            try
            {
                ...
                var userName = pg_Hrms.ConnectToMySql(SQLQUIRIES.SQLPERMEMPWITHMATERNITYLEAVES.GetDescription());
                ...
                string toDate = DateTime.Now.AddDays(182).ToString("dd-MM-yyyy");

                Step = "Create Leave Request";
                pg_Hrms.CreateImpersonateLeaveRequest(LEAVETYPES.MATERNITYLEAVE.GetDescription(), date, toDate, FULLDAYLEAVE, userName[1]);
