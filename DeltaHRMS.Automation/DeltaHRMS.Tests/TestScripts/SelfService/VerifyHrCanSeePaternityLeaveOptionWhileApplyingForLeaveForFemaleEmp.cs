...
{
    [Script("", "", "DeltaHRMS", "SelfService", "HR - Verify Leave Options For Female Employee", "Verify Hr Can See Paternity Leave Option While Applying For Leave For Female Employee", "Regression")]
    /// <summary>
    ///  Delta HRMS - Cancel Approved Leave
    /// </summary>
    class VerifyHrCanSeePaternityLeaveOptionWhileApplyingForLeaveForFemaleEmp : BaseTest
    {
        /// <summary>
        ...
        protected override void ExecuteTestCase()
        {
            try
            {
                ...
                pg_Hrms.VerifyLeaveTypesForEmployee(userName[1], LEAVETYPES.PATERNITYLEAVE.GetDescription(), "Doesnt Exists");
            }
            catch (Exception ex)
            {
