...
namespace DeltaHRMS.Accelerators.Utilities
{
    ...
    public static class Locator
    {
        ...
        public static Dictionary<string, Dictionary<string, Dictionary<string, List<BrowserFinder>>>> LoadPageObjects(string restra)
        {
                    ...
                    if (listOfPages[i].Attributes[0].Value.Equals(restra))
                    {
                        ...
                        for (int j = 0; j < pages.Count; j++)
                        {
                            ...
                            for (int k = 0; k < objects.Count; k++)
                            {
                                ...
                                //  controlFinder[hotel].Add(carrabasObjects[0].Attributes[0].Value, listBroswerFinder);
                            }
            ...
            {
                throw new Exception(ex.Message + string.Format(" {0}", key));
            }
        }
